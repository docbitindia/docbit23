    ...
    <div className="flex flex-col h-full">
      ...
      {searchHasNoMatches ? (
        ...
        <>
          ...
          >
            <div data-zoom-layer className="relative inline-block align-top" style={{ width: 'max-content', height: 'max-content' }}>
            <table
              className="border-separate border-spacing-0 text-sm"
              style={{
                minWidth: `${Math.max(640, report.columns.reduce((sum, c) => sum + c.settings.width, 0) + (report.columns.length + 1) * INSERT_GUTTER_WIDTH + 92)}px`,
                tableLayout: 'fixed',
