    ...
    <div className={`${embedded ? 'h-[760px] max-h-[80vh] min-h-[620px]' : 'h-screen'} flex flex-col`} style={{ ['--docbit-modal-left' as string]: `${navCollapsed ? 56 : sidebarWidth}px` }}>
      <div className="flex-1 flex min-h-0">
        ...
        <div className="flex min-w-0 min-h-0 flex-1 flex-col">
          <TopBar onBack={onBack} onReset={onReset} canReset={canReset} onUndo={onUndo} onRedo={onRedo} canUndo={canUndo} canRedo={canRedo} onSave={onSave} saveLabel={saveLabel} canSave={canSave} onAddToProject={onAddToProject} onGeneratePdf={onGeneratePdf} backOnRight={backOnRight} />
