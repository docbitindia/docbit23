...
// A plain, well-formatted workbook: proper column widths, grouped sections,
// and summary rows — no branding, no title block, no visual template. This
// is a data extraction tool, not a document designer.
