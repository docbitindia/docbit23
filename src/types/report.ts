...
/** Formatting settings that apply to every export format — Excel, CSV, and
 *  JSON. There is no PDF, no branding, no visual template: DocBit is a data
 *  extractor, not a document designer. */
